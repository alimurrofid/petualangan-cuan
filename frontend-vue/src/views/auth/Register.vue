...
<template>
  <div class="min-h-screen grid lg:grid-cols-2">
    <!-- Left: Branding -->
    <div class="hidden lg:flex flex-col justify-between p-10 bg-gradient-to-bl from-teal-900 to-emerald-900 text-white relative overflow-hidden">
         <!-- Decorative Elements -->
        ...
        <div class="relative z-10 flex items-center justify-start gap-2">
        ...
        <div class="relative z-10 space-y-4 max-w-lg text-left">
            <h1 class="text-5xl font-bold leading-tight">
                Mulai langkah awal <span class="text-emerald-400">kesuksesan</span> finansial Anda.
            </h1>
            <p class="text-lg text-emerald-100/80">
                Buat akun baru dan nikmati kemudahan mencatat dan menganalisis pengeluaran Anda.
            </p>
        </div>

        <div class="relative z-10 text-sm text-emerald-200/50 text-left">
    ...
    <div class="flex items-center justify-center p-8 bg-background">
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="space-y-6">
                 <div class="space-y-4">
                    <a :href="`${apiBaseUrl}api/auth/google`" class="w-full">
                    ...
                    <div class="space-y-4">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <Input id="name" type="text" placeholder="John Doe" class="pl-10 h-10" v-model="name" required />
                            </div>
                        </div>
                        <div class="space-y-2">
            ...
            <div class="text-center text-sm">
                Sudah punya akun? 
                <RouterLink to="/login" class="font-medium text-emerald-600 hover:text-emerald-500 hover:underline">
                    Masuk disini
                </RouterLink>
            </div>
        </div>
