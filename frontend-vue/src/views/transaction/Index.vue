...
<template>
  <div class="flex-1 space-y-6 pt-2">
    ...
    <div v-if="transactionStore.isLoading && !transactionStore.transactions.length && !searchQuery"
    ...
    <div class="flex-1 space-y-6 pt-2 text-foreground" v-else>
      ...
      <div class="space-y-6 relative">
        <!-- Toolbar -->
        <TransactionFilter v-model:periodType="periodType" v-model:walletIds="filterWallet"
          v-model:categoryIds="filterCategory" :startDate="customDateRange.start" :endDate="customDateRange.end"
          :formattedDateRange="formattedDateRange" @navigateDate="navigateDate"
        ...
        <div class="grid lg:grid-cols-3 gap-6 md:h-[600px] overflow-hidden">
          ...
          <Card class="lg:col-span-2 bg-card border-border shadow-sm flex flex-col rounded-3xl overflow-hidden h-full">
            ...
            <CardContent class="flex-1 p-4 relative min-h-[250px] md:min-h-[300px]">
              <TransactionChart class="h-full w-full" :summaryData="transactionStore.calendarData"
          ...
          <Card class="bg-card border-border shadow-sm flex flex-col rounded-3xl overflow-hidden h-full">
            <CardHeader class="pb-3 border-b border-border/50 space-y-3">
              <div class="flex items-center justify-between w-full">
                ...
                <Button @click="handleExport" title="Ekspor Excel" variant="outline"
              ...
              <div class="relative w-full">
                ...
                <Input v-model="localSearch" placeholder="Cari transaksi..."
